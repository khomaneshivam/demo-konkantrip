...
const registerUser = require("./src/routes/auth/RegisterRoutes");
const loginUser = require("./src/routes/auth/LoginRoutes");
const propertyOwnerLoginLogsRoutes = require("./src/routes/auth/PropertyOwnerLoginLogsRoutes");
const updatePasswordRoutes = require("./src/routes/auth/UpdatePasswordRoutes");
...
app.use("/api/property_owner_login_logs", propertyOwnerLoginLogsRoutes);
